    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_api_main);
            ...
            private void getBooksInfo(String query) {
                ...
                RequestQueue mRequestQueue = Volley.newRequestQueue(ApiMainActivity.this);
                ...
                RequestQueue queue = Volley.newRequestQueue(ApiMainActivity.this);
                ...
                JsonObjectRequest booksObjrequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < itemsArray.length(); i++) {
                                ...
                                BookAdapter adapter = new BookAdapter(bookInfoArrayList, ApiMainActivity.this);

                                // below line is use to add linear layout
                                // manager for our recycler view.
                                LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ApiMainActivity.this, RecyclerView.VERTICAL, false);
                            ...
                            Toast.makeText(ApiMainActivity.this, "No Data Found" + e, Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ApiMainActivity.this, "Error found is " + error, Toast.LENGTH_SHORT).show();
                    }
                });
